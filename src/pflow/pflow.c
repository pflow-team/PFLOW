...
#undef __FUNCT__
#define __FUNCT__ "PFLOWLibraryInitialize"
/*
  Calls PetscInitilaize
*/
PetscErrorCode PFLOWLibraryInitialize(int argc, char **args, const char* filename, const char *help)
{
  PetscErrorCode ierr;
  
  PetscFunctionBegin;
  ierr = PetscInitializeNoPointers(argc,args,filename,help);CHKERRQ(ierr);
  PetscFunctionReturn(0);
}

#undef __FUNCT__
#define __FUNCT__ "PFLOWInitialized"
/*
  Checks if PFLOW is initialized 
*/
PetscErrorCode PFLOWLibraryInitialized(PetscBool *isInitialized)
{
  PetscErrorCode ierr;

  PetscFunctionBegin;
  ierr = PetscInitialized(isInitialized);CHKERRQ(ierr);
  PetscFunctionReturn(0);
}

#undef __FUNCT__
#define __FUNCT__ "PFLOWLibraryFinalize"
/*
  Finalize PFLOW 
*/
PetscErrorCode PFLOWLibraryFinalize(void)
{
  PetscFinalize();
  return 0;
}
...
#undef __FUNCT__
#define __FUNCT__ "PFLOWGetPETSC_COMM_SELF"
/*
      Used by MATLAB interface to get communicator
*/
PetscErrorCode  PFLOWGetPETSC_COMM_SELF(MPI_Comm *comm)
{
  PetscFunctionBegin;
