...
/* FUNCTIONS FOR PYTHON WRAPPER */
PETSC_EXTERN PetscErrorCode PFLOWLibraryInitialize(int,char**,const char*,const char*);
PETSC_EXTERN PetscErrorCode PFLOWLibraryInitialized(PetscBool*);
PETSC_EXTERN PetscErrorCode PFLOWLibraryFinalize(void);
PETSC_EXTERN PetscErrorCode PFLOWGetPETSC_COMM_SELF(MPI_Comm *comm);
